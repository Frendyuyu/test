...
-- 
-- DATE : 2023-01-14 17:01:16
-- MYSQL SERVER VERSION : 5.7.26
-- PHP VERSION : 7.3.4
-- DouPHP VERSION : v1.7 Release 20240611
...
INSERT INTO dou_admin VALUES('1','admin','admin@admin.com','7fef6171469e80d32c0559f88b377245','ALL','1663644263','127.0.0.1','1377768032');
...
INSERT INTO dou_article VALUES('1','1','DouPHP后台登录不了','','<p>后台登录不了，主要问题集中在，输入正确的验证码后仍然提示验证码不对，这个问题造成的原因是输入的验证码无法传送给后台程序，造成这个问题多数是由于服务器不支持session或者cookie造成，所以这个时候您就需要与空间商取得联系，让他们开启session和cookie功能，如果是自己的服务器，则需自己查阅相关技术文档解决此问题。</p>','pcrsl28.file','0','','后台登录不了，主要问题集中在，输入正确的验证码后仍然提示验证码不对，这个问题造成的原因是输入的验证码无法传送给后台程序，造成这个问题多数是由于服务器不支持session或者cookie造成，所以这个时候您就需要与空间商取得联系，让他们开启session和cookie功能，如果是自己的服务器，则需自己查阅相关技术文档解决此问题。','50','1372261140');
INSERT INTO dou_article VALUES('2','1','使用DouBAK将您的网站转移至另一个服务器','','<p>1.下载程序并解压。<br />2.将doubak目录上传至站点根目录。<br />3.运行http://www.domain.com/doubak(domain表示你的域名)，点击\"立即备份\"将数据库备份。<br />4，将站点文件下载并修改\"data/config.php\"改成新服务器的数据库信息。<br />5，最后上传所有站点文件至新的服务器，运行http://www.domain.com/doubak点击\"恢复数据库\"即可。</p>','9vffckc.file','0','','1.下载程序并解压。2.将doubak目录上传至站点根目录。3.运行备份功能网址，点击\"立即备份\"将数据库备份。4，将站点文件下载并修改数据库配置文件改成新服务器的数据库信息。然后到新服务器上进行恢复操作','50','1372261380');
INSERT INTO dou_article VALUES('3','1','新安装或者升级后都是乱码','','<p>造成乱码问题一般是由于上传PHP文件时，FTP没有开启二进制上传模式造成的，解决方法是使用二进制重新上传一次。<br /><br />几种常见的FTP软件的二进制设置说明：<br /><br />1、FlashFXP：<br />打开 FlashFXP：在工具栏中，选项 =&gt; 参数（也可以直接按F6键），在弹出来的窗口中，选择&ldquo;传输(T)&rdquo;卡，在传输模式中选择&ldquo;二进制&rdquo;。<br /><br />2、LeapFTP：<br />打开 LeapFTP： 在 Options（选项）菜单中选择 Parameters（参数设置），选择其中的（ASCII 扩展名），出现列表后，选中其中的&ldquo;*.PHP&rdquo;，点右边的（删除），再点右边的（确定）即可。如果&ldquo;*.PHP&rdquo;项目不存在的话，可直接使用，不需另行设置。<br /><br />3、CuteFTP：<br />打开 CuteFTP： 进入软件后按 ALT+F7 进入 Global Options（全局选项），传输 =&gt; 传输方式 =&gt;&nbsp;<br /><br />二进制<br />4、filezilla<br />打开 filezilla： 在工具栏中，传输 =&gt; 传送类型 =&gt; 选择&ldquo;二进制&rdquo;<br /><br />注意：二进制是binary 不是ASCII！！<br /><br /></p>','1r4mciv.file','0','','造成乱码问题一般是由于上传PHP文件时，FTP没有开启二进制上传模式造成的，解决方法是使用二进制重新上传一次。几种常见的FTP软件的二进制设置说明：打开FTP软件在工具栏中，选项-参数也可以直接按F6键，在弹出来的窗口中，选择“传输(T)”卡，在传输模式中选择“二进制”。','50','1372261500');
INSERT INTO dou_article VALUES('4','1','开启伪静态后提示500错误','','<p>如果您开启伪静态后网站无法打开，提示500错误，一般是由于服务器本身不支持伪静态造成，需要联系空间商重启服务器并开启伪静态功能</p>','ysqxp3n.file','0','','如果您开启伪静态后网站无法打开，提示500错误，一般是由于服务器本身不支持伪静态造成，需要联系空间商重启服务器并开启伪静态功能，否则无法正常使用伪静态功能，当然也可以关闭伪静态功能不使用','50','1372261500');
INSERT INTO dou_article VALUES('5','1','网站建设要素之如何制定一份网站策划方案','','<p>要建立一个网站，需要从网站定位，到设计、网站结构、内容准备、内外链的建设等等，是一个复杂繁琐的过程，需要准备一份网站的策划方案。本文将简要描述，从网站的定位到最终的网站建成，整个过程。<br /><br />一、网站的定位<br /><br />分析：给网站定位，策划一个网站，这是第一步，只有给网站定位好了，才能按照定位的关键词展开。如何给网站定位，如何选择网站的核心关键词。选择核心关键词，需要考虑的因素有：搜索量大、有一定的商业价值、竞争度相对较低。<br /><br />这里有个小建议，一般建站前，肯定清楚网站属于哪一个类别，然后根据这个类别的核心关键词，通过百度蜂巢系统，将相关关键词拉出，再根据需要考虑的因素，选择最合适的关键词<br /><br />二、确定网站三要素<br /><br />分析：建站的三要素，指的是程序、域名和空间，在确定了网站的核心关键词以后，可以由关键词确定网站名称，然后再根据网站名称，选择域名；根据网站主题，选择程序；关于空间，最好是正规空间商提供的服务器，稳定、安全，虽然价格可能比较贵。<br /><br />在建立网站需要哪些条件一文中，有详细介绍网站三要素的内容，感兴趣的童鞋可以看看。<br /><br />三、确定网站关键词<br /><br />分析：这里所说的关键词，是根据已经定位好的核心关键词，再总结所有长尾词的特点，确定一批转化率较高的长尾词，可以作为网站的目录等，分布在首页中<br /><br />四、确定网站标题标签<br /><br />分析：在网站的定位时，已经确定了网站的关键词，然后再根据网站的关键词，填写网站标题、关键词标签、描述标签。这些都是网站优化的基础，需要注意的是，尽量将内容写的自然，关键词千万不要堆积。标题中，包括三个关键词即可<br /><br />五、完善网站布局<br /><br />分析：根据前面确定的关键词、长尾词体系，完善网站的子目录及首页的布局，包括核心关键词、近义词、同义词等，增加关键词的密度。下一章，Q猪将从分析robin的广场舞的首页，讲一下网站如何布局。<br /><br />六、构建网站结构<br /><br />分析：网站的结构尽量以扁平树形结构，具体可以看下，如何制作合理的网站结构。在构建网站结构的同时，注意URL的简单、规范。<br /><br />七、编辑网站内容<br /><br />分析：网站的内容，尽量以原创和质量较高的微原创为主，注意网站内链的建设，可以建立一份长尾词记录单，记录每一篇文章优化的关键词。<br /><br />在编辑文章内容时，注意关键词的四处一词，标题，关键词标签、描述，正文，还有网站其他页面关于帖子的锚文本。<br /><br />如果网站的内容编辑，积累到一定程度以后，可以将网站的URL提交给搜索引擎即可。然后就是外链的建设，还有网站内容的，逐步增加。</p>','scfmpzw.file','2','网站策划','要建立一个网站，需要从网站定位，到设计、网站结构、内容准备、内外链的建设等等，是一个复杂繁琐的过程，需要准备一份网站的策划方案。本文将简要描述，从网站的定位到最终的网站建成，整个过程。','50','1372261620');
INSERT INTO dou_article VALUES('6','1','如何新增语言文件','','<p>第一步 在 &ldquo;languages&rdquo;目录下建立如 &ldquo;zh_tw&rdquo; 然后将拷贝 zh_cn 下的 web.lang.php 到这个目录下<br /><br />第二步 登陆DouPHP后台，在 &ldquo;系统设置&rdquo; -&gt; &ldquo;系统语言&rdquo; 选择您刚才添加的语言<br /><br />提示：由于国内使用即使是英文版的网站后台也是中文的，所以暂不开放后台语言的切换<br /><br /></p>','5dvi968.file','13','','第一步在语言文件目录下建立如新的语言文件包；第二步登陆DouPHP后台，在“系统设置”-“系统语言”选择您刚才添加的语言。提示：由于国内使用即使是英文版的网站后台也是中文的，所以暂不开放后台语言的切换','50','1372261740');
INSERT INTO dou_article VALUES('7','2','如何修改手机版地址','','<p>1，打开&ldquo;data/config.php&rdquo;找到 define(\'M_PATH\',\'m\') 将 m 改为新的后台目录名称<br />2，找到根目录下&ldquo;m&rdquo;目录改为新的后台目录名称<br /><br /></p>','3a5ersn.file','2','','1，打开系统数据库配置文件找到对应的手机版目录配置参数将m改为新的后台目录名称；2，找到根目录下m目录改为新的后台目录名称。一定注意实际目录和参数都要改了才会有效，否则会出错','50','1372261860');
INSERT INTO dou_article VALUES('8','2','图片无法上传或者缩略图无法生成','','<p>1，根目录下images和data目录无写入权限（注：包括其下子目录）<br />2，服务器没有开启文件上传功能<br /><br />造成缩略图无法生成主要原因：服务器没有开启GD库功能<br /><br /></p>','h66rjpb.file','0','','1，根目录下images和data目录无写入权限注：包括其下子目录；2，服务器没有开启文件上传功能；造成缩略图无法生成主要原因：服务器没有开启GD库功能，如果还是不行，可以更换个服务器试看看','50','1372261980');
INSERT INTO dou_article VALUES('9','2','如何建立一个新的DouPHP模板','','<p>第一步 打开 &ldquo;theme&rdquo;目录 ，将&ldquo;default&rdquo;目录复制一份，更名为您打算制作的模板名称（可包含英文或数字），然后打开您的模板，了解下模板目录结构<br /><br />第二步 登陆DouPHP后台，在 &ldquo;系统设置&rdquo; -&gt; &ldquo;站点模板&rdquo; 选择您刚才添加的模板<br /><br /></p>','xlmxlw3.file','14','','第一步打开theme目录，将default目录复制一份，更名为您打算制作的模板名称可包含英文或数字，然后打开您的模板，了解下模板目录结构；第二步登陆DouPHP后台，在“系统设置”-“站点模板”选择您刚才添加的模板','50','1372262040');
INSERT INTO dou_article VALUES('10','1','如何添加自定义字段','','<p>以商品为例，如果要给商品加上自定义字段，首先找到-&gt;系统设置-&gt;[自定义]然后填入如-&gt;颜色,尺寸,型号-&gt;中间以英文逗号隔开，然后在商品编辑页面会看到相应的自定义字段，输入对应的值即可</p>','jwbdr85.file','131','','以商品为例，如果要给商品加上自定义字段，首先找到系统设置-自定义然后填入如“颜色,尺寸,型号”中间以英文逗号隔开，然后在商品编辑页面会看到相应的自定义字段，输入对应的值即可','50','1372262040');
...
DROP TABLE IF EXISTS `dou_box`;
CREATE TABLE `dou_box` (
  `id` smallint(5) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(60) NOT NULL DEFAULT '',
  `class` varchar(120) NOT NULL DEFAULT '',
  `class_unique_id` varchar(60) NOT NULL DEFAULT '',
  `text` text NOT NULL,
...
CREATE TABLE `dou_config` (
  ...
  `tab` varchar(30) NOT NULL DEFAULT 'main',
...
INSERT INTO dou_config VALUES('site_logo_other','','file','','main','5');
INSERT INTO dou_config VALUES('site_closed','0','radio','','main','6');
INSERT INTO dou_config VALUES('rewrite','1','radio','','main','7');
INSERT INTO dou_config VALUES('address','福建省漳州市芗城区','text','','main','8');
INSERT INTO dou_config VALUES('icp','','text','','main','9');
INSERT INTO dou_config VALUES('net_safe_record','','text','','main','10');
INSERT INTO dou_config VALUES('tel','0596-8888888','text','','main','11');
INSERT INTO dou_config VALUES('fax','0596-6666666','text','','main','12');
...
INSERT INTO dou_config VALUES('ssl','0','radio','','main','15');
INSERT INTO dou_config VALUES('domain','','text','','main','16');
INSERT INTO dou_config VALUES('sitemap','1','radio','','main','17');
INSERT INTO dou_config VALUES('close_mobile','1','radio','','main','18');
INSERT INTO dou_config VALUES('captcha','1','radio','','main','19');
INSERT INTO dou_config VALUES('stock','0','radio','','main','20');
INSERT INTO dou_config VALUES('show_price','1','radio','','main','21');
INSERT INTO dou_config VALUES('input_must_include_chinese','1','radio','','main','22');
INSERT INTO dou_config VALUES('site_favicon','favicon.ico','file','','main','23');
INSERT INTO dou_config VALUES('code','','textarea','','main','24');
INSERT INTO dou_config VALUES('show_customer','1','radio','','customer','1');
INSERT INTO dou_config VALUES('qq','','text','','customer','2');
INSERT INTO dou_config VALUES('weixin_name','微信二维码','text','','customer','3');
INSERT INTO dou_config VALUES('weixin_img','weixin.png','file','','customer','4');
INSERT INTO dou_config VALUES('weibo','','text','','customer','5');
INSERT INTO dou_config VALUES('chat','','text','','customer','6');
INSERT INTO dou_config VALUES('thumb_width','300','text','','display','1');
INSERT INTO dou_config VALUES('thumb_height','300','text','','display','2');
...
INSERT INTO dou_config VALUES('display','a:4:{s:7:\"article\";s:2:\"10\";s:12:\"home_article\";s:1:\"5\";s:7:\"product\";s:2:\"12\";s:12:\"home_product\";s:1:\"4\";}','array','','display','6');
...
INSERT INTO dou_config VALUES('update_overwritten_theme','1','radio','','developer','4');
INSERT INTO dou_config VALUES('open_icon','0','radio','','developer','5');
...
INSERT INTO dou_config VALUES('update_date','a:3:{s:6:\"system\";a:2:{s:6:\"update\";s:8:\"20240611\";s:5:\"patch\";s:8:\"20240611\";}s:6:\"module\";a:4:{s:7:\"article\";s:8:\"20240611\";s:7:\"product\";s:8:\"20240611\";s:3:\"box\";s:8:\"20240611\";s:8:\"fragment\";s:8:\"20240611\";}s:5:\"theme\";a:0:{}}','hidden','','','7');
INSERT INTO dou_config VALUES('file_update_time','1653395208','hidden','','','8');
INSERT INTO dou_config VALUES('cloud_account','','hidden','','','9');
INSERT INTO dou_config VALUES('system_type','company','hidden','','','10');
INSERT INTO dou_config VALUES('hash_code','166d0de32dafdef9ab26e10130dd115b','hidden','','','11');
INSERT INTO dou_config VALUES('douphp_version','v1.7 Release 20240611','hidden','','','12');
...
INSERT INTO dou_file VALUES('16','9mqr53t.file','data/slide/20130514acunau.jpg','show','1','main','58487','0','1649149414','1530249928');
...
INSERT INTO dou_file VALUES('26','jwbdr85.file','images/article/10_1590637651640490.jpg','article','10','main','83272','0','1590637651','1590637651');
INSERT INTO dou_file VALUES('27','pcrsl28.file','images/article/1_1592028494553634.jpg','article','1','main','122290','0','1592028494','1592028494');
INSERT INTO dou_file VALUES('28','9vffckc.file','images/article/2_1592028510001240.jpg','article','2','main','170951','0','1592028510','1592028510');
INSERT INTO dou_file VALUES('29','1r4mciv.file','images/article/3_1592028517984751.jpg','article','3','main','206343','0','1592028517','1592028517');
INSERT INTO dou_file VALUES('30','ysqxp3n.file','images/article/4_1592028523433036.jpg','article','4','main','82480','0','1592028523','1592028523');
INSERT INTO dou_file VALUES('31','scfmpzw.file','images/article/5_1592028529022710.jpg','article','5','main','194456','0','1592028530','1592028530');
INSERT INTO dou_file VALUES('32','5dvi968.file','images/article/6_1592028536095762.jpg','article','6','main','90912','0','1592028536','1592028536');
INSERT INTO dou_file VALUES('33','3a5ersn.file','images/article/7_1592028542064078.jpg','article','7','main','128995','0','1592028542','1592028542');
INSERT INTO dou_file VALUES('34','h66rjpb.file','images/article/8_1592028547020909.jpg','article','8','main','44993','0','1592028547','1592028547');
INSERT INTO dou_file VALUES('35','xlmxlw3.file','images/article/9_1592028554471746.jpg','article','9','main','147605','0','1592028554','1592028554');
INSERT INTO dou_file VALUES('36','rasnk4e.file','images/fragment/about.jpg','fragment','1','main','51970','0','1590637618','1590637618');
INSERT INTO dou_file VALUES('37','yx1cj8z.file','images/fragment/weixin.png','fragment','2','main','5934','0','1590637634','1590637634');

DROP TABLE IF EXISTS `dou_fragment`;
CREATE TABLE `dou_fragment` (
  `id` smallint(5) unsigned NOT NULL AUTO_INCREMENT,
  ...
  `text` text NOT NULL,
  `link` varchar(255) NOT NULL DEFAULT '',
  `box` varchar(60) NOT NULL DEFAULT '',
...
INSERT INTO dou_fragment VALUES('1','首页关于我们','about','0','rasnk4e.file','','','','0','','0','0');
...
INSERT INTO dou_nav VALUES('10','product_category','主分类一','','1','5','middle','10');
INSERT INTO dou_nav VALUES('11','product_category','主分类二','','2','5','middle','20');
INSERT INTO dou_nav VALUES('12','product_category','主分类三','','3','5','middle','30');
...
INSERT INTO dou_nav VALUES('16','product_category','子分类一','','4','10','middle','1');
INSERT INTO dou_nav VALUES('17','product_category','子分类二','','5','10','middle','2');
INSERT INTO dou_nav VALUES('18','page','公司简介','','1','0','mobile','10');
INSERT INTO dou_nav VALUES('19','product_category','产品中心','','0','0','mobile','20');
INSERT INTO dou_nav VALUES('20','article_category','文章中心','','0','0','mobile','30');
INSERT INTO dou_nav VALUES('21','page','企业荣誉','','2','0','mobile','40');
INSERT INTO dou_nav VALUES('22','page','营销网络','','6','0','mobile','50');
INSERT INTO dou_nav VALUES('23','page','人才招聘','','5','0','mobile','60');
INSERT INTO dou_nav VALUES('24','page','联系我们','','4','0','mobile','255');
...
CREATE TABLE `dou_page` (
  ...
  `keywords` varchar(255) NOT NULL DEFAULT '',
  `description` varchar(255) NOT NULL DEFAULT '',
  `editor_code` varchar(60) NOT NULL DEFAULT '',
  `mode` varchar(60) NOT NULL DEFAULT 'editor',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=7 DEFAULT CHARSET=utf8;

INSERT INTO dou_page VALUES('1','about','0','公司简介','<p>DouPHP 漳州豆壳网络科技有限公司开发的一款轻量级企业网站管理系统，基于PHP+Mysql架构的，可运行在Linux、Windows、MacOSX、Solaris等各种平台上，系统搭载Smarty模板引擎，支持自定义伪静态，前台模板采用DIV+CSS设计，后台界面设计简洁明了，功能简单易具有良好的用户体验，稳定性好、扩展性及安全性强，可通过后台在线安装模块，比如会员模块、订单模块等，可面向中小型站点提供网站建设解决方案。<br /><br /><strong>人性化的后台管理</strong><br />传统的企业网站管理系统是以技术人员的角度出发，设计了很多复杂的功能，并且操作流程上也很复杂，对于最终要操控这个系统的管理员来说并不是很人性化，DouPHP所做的只是简化不必要的功能，从操作习惯下合理地布局和设计界面，让最普通的用户，即使没有网站管理的经营，也能很容易上手我们的系统。<br /><br /><strong>手机版+小程序+微信公众号</strong><br />DouPHP助您进入移动互联网时代，DouPHP手机版版面完全根据触屏设备来做的深度定制，保持跟PC端一样的简约风格，并加入很多手机端的优化，拥有很高的用户体验，手机版自动调用PC版的内容，并在后台独立出一个配置中心，可以单独设定手机版的幻灯、导航栏等一些常规配置；1.5版本开始还加入了微信公众号管理、小程序，基于DouPHP平台可以轻松定制出各种小程序（默认安装不带小程序，如有需要可以通过&ldquo;DouPHP+&rdquo;免费在线安装）。<br /><br /><strong>系统功能模块化操作</strong><br />DouPHP初始安装的功能十分简单，用以满足基本的企业网站建设需求。但如果您需要更多功能，则可以借助DouPHP强大的扩展功能进行在线获取与安装模块，比如您需要会员功能，则通过后台的&ldquo;DouPHP+&rdquo;选择会员模块，然后点击安装即可。或者您想将DouPHP做成一个轻量级购物网站，只需另外再安装订单和插件功能即可。如果您要卸载某些模块，则可以通过&ldquo;DouPHP+&rdquo;模块卸载功能完成。通过这种方式DouPHP将可以实现更多功能，但又不失轻量的特性。<br /><br /><strong>全站DIV+CSS设计，利于SEO</strong><br />使用DIV+CSS布局，页面代码精简，DIV+CSS布局较Table布局减少了页面代码，加载速度得到很大的提高。代码精简所带来的直接好处有两点：一是提高蜘蛛爬行效率，能在最短的时间内爬完整个页面，这样对收录质量有一定好处；二是由于能高效的爬行，就会受到蜘蛛喜欢，这样对收录数量有一定好处。<br /><br /><strong>自定义伪静态<br /></strong>大家都知道静态页面对SEO有很大益处，但是静态页面会产生大量的磁盘I/O操作以及磁盘碎片问题，最主要的是不方便网站更新。而伪静态最大的好处就是让搜索引擎把伪静态网页当做静态页面来处理又避免了静态页面产生的问题，对于信息量不是很大的网站来说，无疑伪静态才是最佳选择，而DouPHP提供的自定义伪静态，可以让您定义出符合用户习惯、看起来又漂亮的URL。</p>','公司简介','DouPHP是一款轻量级企业网站管理系统，基于PHP+Mysql架构的，可运行在Linux、Windows、MacOSX、Solaris等各种平台上，系统搭载Smarty模板引擎，支持自定义伪静态，前台模板采用DIV+CSS设计，后台界面设计简洁明了，功能简单易具有良好的用户体验，稳定性好、扩展性及安全性强，可面向中小型站点提供网站建设解决方案。传统的企业网站管理系统是以技术人员的角度出发，设计了很多复杂的功能，并且操作流程上也很复杂，对于最终要操控这个系统的管理员来说并不是很人性化，DouPHP所做的只','','editor');
INSERT INTO dou_page VALUES('2','honor','1','企业荣誉','企业荣誉','企业荣誉','企业荣誉','','editor');
INSERT INTO dou_page VALUES('3','history','1','发展历程','发展历程','发展历程','发展历程','','editor');
INSERT INTO dou_page VALUES('4','contact','1','联系我们','通讯地址：<br />\r\n<span style=\"color:#D7D7D7;\">--------------------------------------------------------------------------------------------------------------------------------</span><br />\r\n福建省漳州市芗城区，邮编363000<br />\r\n<br />\r\n客服邮箱：<br />\r\n<span style=\"color:#D7D7D7;\">--------------------------------------------------------------------------------------------------------------------------------</span><br />\r\nDouPHP售后服务邮箱：email@email.com<br />\r\nDouPHP业务受理邮箱：<span>email@email.com</span><br />\r\n如您需要订制开发请在邮件中注明您的大概要求，我们将在一个工作日内给予回复。<br />\r\n<br />\r\n客服电话：<br />\r\n<span style=\"color:#D7D7D7;\">--------------------------------------------------------------------------------------------------------------------------------</span><br />\r\n<span>DouPHP</span>的建站咨询电话为 0596-1234567。<br />\r\n客服电话工作时间为周一至周日 8:00-20:00，节假日不休息，免长途话费。<br />\r\n我们将随时为您献上真诚的服务。<br />\r\n<br />\r\n网站网址：<br />\r\n<span style=\"color:#D7D7D7;\">--------------------------------------------------------------------------------------------------------------------------------</span><br />\r\nwww.douphp.com<br />','联系我们','联系我们','','editor');
INSERT INTO dou_page VALUES('5','job','0','人才招聘','人才招聘','人才招聘','人才招聘','','editor');
INSERT INTO dou_page VALUES('6','market','0','营销网络','营销网络','营销网络','营销网络','','editor');
...
CREATE TABLE `dou_product` (
  ...
  `level_price` varchar(255) NOT NULL DEFAULT '',
  `stock` smallint(6) unsigned NOT NULL DEFAULT '0',
  `defined` text NOT NULL,
  `content` longtext NOT NULL,
  `image` varchar(255) NOT NULL DEFAULT '',
  `model` varchar(60) NOT NULL DEFAULT '',
  `point` smallint(8) unsigned NOT NULL DEFAULT '0',
  `keywords` varchar(255) NOT NULL DEFAULT '',
  `description` varchar(255) NOT NULL DEFAULT '',
...
INSERT INTO dou_product_category VALUES('1','fenleiyi','主分类一','','产品分类一','产品分类一','0','10');
INSERT INTO dou_product_category VALUES('2','fenleier','主分类二','','产品分类二','产品分类二','0','20');
INSERT INTO dou_product_category VALUES('3','fenleisan','主分类三','','产品分类三','产品分类三','0','30');
INSERT INTO dou_product_category VALUES('4','yiziyi','子分类一','','子分类一','子分类一','1','50');
INSERT INTO dou_product_category VALUES('5','yizier','子分类二','','子分类二','子分类二','1','50');
...
INSERT INTO dou_show VALUES('2','广告图片02','https://www.douphp.com','9ckaw93.file','','pc','2');
INSERT INTO dou_show VALUES('3','广告图片03','https://www.douphp.com','rupuz6g.file','','pc','3');
INSERT INTO dou_show VALUES('4','广告图片04','https://www.douphp.com','gryv365.file','','pc','4');
INSERT INTO dou_show VALUES('5','手机版广告图片01','https://m.douphp.com','ods99li.file','','mobile','10');
INSERT INTO dou_show VALUES('6','手机版广告图片02','https://m.douphp.com','3bgcgri.file','','mobile','20');
INSERT INTO dou_show VALUES('7','手机版广告图片03','https://m.douphp.com','i9lo99y.file','','mobile','30');
INSERT INTO dou_show VALUES('8','手机版广告图片04','https://m.douphp.com','jljwmcv.file','','mobile','40');
