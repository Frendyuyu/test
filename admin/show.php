...
if ($rec == 'default') {
    ...
    // 赋值给模板
    $smarty->assign('btn_lang', $dou->btn_lang('show', '', 'show_name, show_img, show_text'));
...
elseif ($rec == 'insert') {
    ...
    $sql = "INSERT INTO " . $dou->table('show') . " (id, show_name, show_link, show_img, show_text, type, sort)" . " VALUES (NULL, '$_POST[show_name]', '$_POST[show_link]', '$show_img', '$_POST[show_text]', 'pc', '$_POST[sort]')";
    $dou->query($sql);
...
elseif ($rec == 'edit') {
    ...
    $smarty->assign('btn_lang', $dou->btn_lang('show', $id, 'show_name, show_img, show_text'));
